...
$string['course_overview_lite:myaddinstance'] = 'Add a new course overview block to My home.';
$string['course_overview_lite:addinstance'] = 'Add a new course overview block.';
$string['currentcourses'] = 'current/upcoming courses';
...
$string['highlightdelim'] = 'Highlight delimiter';
$string['highlightdelimdesc'] = 'Delimiter by which to split the prefix to match against multiple terms.';
...
$string['showwelcomearea'] = 'Show alert area';
$string['showwelcomeareadesc'] = 'Show the alert area above the course list?';
$string['tabsimple'] = 'Simple';
$string['tabdetailed'] = 'Detailed';
$string['view_edit_profile'] = '(View and edit your profile.)';
$string['welcomeareatext'] = 'Alert area message';
$string['welcomeareatextdesc'] = 'Message to be shown in the alert area.';
